...
namespace BattleBomb.Gameplay.Data
{
    ...
    public sealed class AttackSpec
    {
        ...
        [Tooltip("Steps of stun the hit inflicts (D46 — Earth's wall). 0 for attacks that merely hit.")]
        [SerializeField] private int _stunSteps;
