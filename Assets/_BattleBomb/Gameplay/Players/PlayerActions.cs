namespace BattleBomb.Gameplay.Players
{
    ...
    /// Referenced by name because each seat's <c>SeatInput</c> reads its own copy of the asset (D57);
    /// these constants are the single place a rename has to be reflected.
    /// </summary>
